...
namespace DNSProxy
{
    class Program
    {
        ...
        static async Task OnQueryReceived(object sender, QueryReceivedEventArgs e)
        {
            ...
            /*
            // Console.WriteLine(dnsConfigs.Count());
            Console.WriteLine(dnsConfigs
                .Where(d => d.IsDefault == false && !d.Domain.Equals("*"))
            ...
            */
            ...
            Console.WriteLine(question.Name.ToString() + " ? " + currentConfig.Name + currentConfig.IP);
            ...
            Console.WriteLine(question.Name.ToString() + " + " + currentConfig.Name + " " + response.ReturnCode);
